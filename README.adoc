...
`helisa` will be released on Maven Central soon - track https://github.com/softwaremill/helisa/issues/1[this issue] to know when that happens. In the meantime, feel free to clone this repo and use it as a local dependency. Sorry about the delay!
